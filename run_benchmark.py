...
def main():
    ...
    ax1.set_xlabel('Spatial Coordinate z [Index]', fontsize=9, fontweight='bold')
    ax1.set_ylabel('Normalized Amplitude', fontsize=9, fontweight='bold')
    ax1.set_xlim(0, N - 1)
    ...
    ax2.set_xlabel('Spatial Coordinate z [Index]', fontsize=9, fontweight='bold')
    ax2.set_ylabel('Unregularized Estimate x̂', fontsize=9, fontweight='bold')
    ax2.set_xlim(0, N - 1)
    ax2.set_ylim(-2.0, 3.0)
    ax2.grid(False)
    ax2.legend(loc='upper right', frameon=True)
    
    # Panel 3: Classical Tikhonov Regularization
    ax3 = axes[1, 0]
    ...
    ax3.set_xlabel('Spatial Coordinate z [Index]', fontsize=9, fontweight='bold')
    ax3.set_ylabel('Material Density x̂(z)', fontsize=9, fontweight='bold')
    ax3.set_xlim(0, N - 1)
    ax3.set_ylim(-0.25, 1.35)
    ax3.grid(False)
    ax3.legend(loc='upper right', frameon=True)
    
    # Panel 4: Physics-Informed Variational Inversion (TV)
    ax4 = axes[1, 1]
    ...
    ax4.set_xlabel('Spatial Coordinate z [Index]', fontsize=9, fontweight='bold')
    ax4.set_ylabel('Material Density x̂(z)', fontsize=9, fontweight='bold')
    ax4.set_xlim(0, N - 1)
